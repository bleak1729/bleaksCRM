// Países ISO 3166-1 con nombre en español (generado con Intl.DisplayNames)
// El código ISO se usa para acotar el autocompletado de provincias/ciudades.
...
export const DEFAULT_COUNTRY: Country = COUNTRIES.find(c => c.code === 'ES')!
